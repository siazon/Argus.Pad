...
namespace Argus.Pad
{
    ...
    /// </summary>
    public sealed partial class MainView : BasePage, INotifyPropertyChanged
    {
        bool isDown = false;
        ...
        private void BigBorder_PointerMoved(object sender, PointerRoutedEventArgs e)
        {
            if (isDown)
            {
                PointerPoint Sp = e.GetCurrentPoint(null);
        ...
        private void BigBorder_PointerReleased(object sender, PointerRoutedEventArgs e)
        {
            if (isDown)
            {
                PointerPoint Sp = e.GetCurrentPoint(null);
